defmodule Superjobs.Plug.Locale do
  import Plug.Conn
  ...
  def call(conn, default) do
    ...
    if is_ietf_tag && locale in Superjobs.Gettext.supported_locales do
  ...
  defp assign_locale!(conn, value) do
    ...
    Gettext.put_locale(Superjobs.Gettext, value)
    conn
    |> assign(:locale, value)
  end
  ...
  defp extract_locale(conn) do
    ...
    |> Enum.filter(fn locale -> Enum.member?(Superjobs.Gettext.supported_locales, locale) end)
  end
